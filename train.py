...
image_datasets['val'] = LocalizeDataset('./data/history_ch', train=False, transform=val_trans,
                                        shuffle=True, split=0.85)
dataloaders = {x: torch.utils.data.DataLoader(image_datasets[x], batch_size=1024, shuffle=True, 
...
lr_schedule = lr_scheduler.StepLR(optimizer_conv, step_size=15, gamma=0.1)
